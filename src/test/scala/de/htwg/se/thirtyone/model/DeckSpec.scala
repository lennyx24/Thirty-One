  ...
  "Deck" should {
    "have a size" in {
      ...
      Deck(15).deck should be(Vector(
        Card('d', "2", 15), Card('d', "3", 15), Card('d', "4", 15), Card('d', "5", 15), Card('d', "6", 15), Card('d', "7", 15), Card('d', "8", 15), Card('d', "9", 15), Card('d', "10", 15), Card('d', "J", 15), Card('d', "Q", 15), Card('d', "K", 15), Card('d', "A", 15),
        Card('s', "2", 15), Card('s', "3", 15), Card('s', "4", 15), Card('s', "5", 15), Card('s', "6", 15), Card('s', "7", 15), Card('s', "8", 15), Card('s', "9", 15), Card('s', "10", 15), Card('s', "J", 15), Card('s', "Q", 15), Card('s', "K", 15), Card('s', "A", 15),
        Card('h', "2", 15), Card('h', "3", 15), Card('h', "4", 15), Card('h', "5", 15), Card('h', "6", 15), Card('h', "7", 15), Card('h', "8", 15), Card('h', "9", 15), Card('h', "10", 15), Card('h', "J", 15), Card('h', "Q", 15), Card('h', "K", 15), Card('h', "A", 15),
        Card('c', "2", 15), Card('c', "3", 15), Card('c', "4", 15), Card('c', "5", 15), Card('c', "6", 15), Card('c', "7", 15), Card('c', "8", 15), Card('c', "9", 15), Card('c', "10", 15), Card('c', "J", 15), Card('c', "Q", 15), Card('c', "K", 15), Card('c', "A", 15)
      ))
    }
  }
}
